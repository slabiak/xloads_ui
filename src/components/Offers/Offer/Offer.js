...
function Offer(props) {
    ...
    let timeIcon = <svg className="bi bi-alarm-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    if(props.data.calculationRequired){
      ...
      //  created.format('pl');
        ...
        routeInfo = 
        <React.Fragment>
         {Math.round((props.data.paths[0].totalTime/ 60 * 100) / 100)} min {mode}<br/>
